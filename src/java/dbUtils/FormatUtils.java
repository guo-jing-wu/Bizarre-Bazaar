...
public class FormatUtils {
    ...
    public static String formatPhone(Object obj) {
        if (obj == null) {
            return "";
        } else {
            try {
                ...
                return "bad phone number in FormatUtils:" + obj.toString() + " Error:" + e.getMessage();
            }
        }
    } // formatInteger

    public static String formatPhoneTd(Object obj) {
        String out = "<td style='text-align:right'>";
        String strInteger = formatPhone(obj);
        if (strInteger.length() == 0) {
            // if you don't put a "non-breaking space" in an empty td/cell, 
            // the cell's border doesn't show !
            out += "&nbsp;";
